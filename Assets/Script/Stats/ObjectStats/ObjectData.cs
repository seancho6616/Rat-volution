...
public class ObjectData : MonoBehaviour
{
    ...
    public float FinalMaxSpawnTime => baseData.mixSpawnTime + runBonus.mixSpawnTime;
    public float FinalMinWarningTime => baseData.minWarningTime + runBonus.minWarningTime;
    public float FinalMaxWarningTime => baseData.mixWarningTime + runBonus.mixWarningTime;
